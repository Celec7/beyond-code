...
`.beyond-code/<slug>/plan.md`. Implementation happens in the build stage AFTER this plan is confirmed.
...
Check `.beyond-code/<slug>/spec.md` (if a formal spec was created):
